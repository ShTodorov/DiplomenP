...
namespace DiplomenP.Data
{
                ...
                var products = new List<Product>
    {
        ...
        new Product { ProductName = "Шапка FilStar No.4", Price = 7.50, Type = "Fishing_clothes", ProductCount = 191,
            ...
            Brand = "Filstar"},
        new Product { ProductName = "Westin w3 Streetstock 2nd 1.83l Въдица", Price = 238.00, Type = "Spinning_rod", ProductCount = 302,
            Image = "https://viyafishing.com/wp-content/uploads/2023/03/Westin_w3_streetstick_2nd_1.jpg",
            Description = "Серията StreetStick предлага модели, с които да можете да покриете риболов с различни примамки според предпочитанията ви  на различни видове - костур, щука, бяла риба, пъстърва или дребни морски видове. Мекият връх, който обаче е комбиниран с бърз строй, позволява безпроблемно замятане цял ден.",
            Brand = "Westin"},
        new Product { ProductName = "Daiwa 21 freams lt 3000", Price = 250.00, Type = "Front_advance", ProductCount = 381,
            Image = "https://smaxfishing.com/images/products/large/5ce7f02204fa4.jpg",
            Description = "Внедрената MagSealed LT конструкция осигурява защита на механизма от попадане на замърсявания, прах, солена вода и др.  Макарата дължи изключителната си производителност на Tough Digigear системата. Впечатлява с безупречен, плавен ход, мощност и сигурна работа.5 бр. висококачествени лагери.",
            Brand = "Daiwa"},
        new Product { ProductName = "Daiwa Samurai pike", Price = 9.00, Type = "Monofilament_line", ProductCount = 294,
            Image = "https://www.tradeinn.com/f/13624/136245318/daiwa-samurai-pike-350-m.jpg",
            Description = "Специално монофилно влакно за риболов на щука. Това влакно отговаря на най-високите, японски стандарти за качество, при изключително съотношение цена-производителност. Дължина-450m.",
            Brand = "Daiwa"},
        new Product { ProductName = "Formax attack pike блесна", Price = 5.00, Type = "Lure", ProductCount = 248,
            Image = "https://orca-bg.com/image/cache/data/blesna-za-ribolov-na-shtuka-formax-pike-500x416.jpg",
            Description = ".Максимално олекотената конструкция в комплект с допълнителна тежест, която може да се демонтира при необходимост, осигурява възможност за адаптиране към условията на риболов.Перфектно решение както за обловяване на плитки и обрасли водоеми, така и за дълбоки участъци.  Сред преимуществата на Attack Pike са сравнително голямото листо със специфична форма, което генерира мощна вибрация, както и добавеният червен атрактор на тройната кука.",
            Brand = "Formax"},
        new Product { ProductName = "Повод за щука Wolfram Falcon", Price = 2.00, Type = "Fishing_accessories", ProductCount = 355,
            Image = "https://bulit2000.com/image/29295.jpg",
            Description = "Мек и гъвкав волфрамов повод с дължина от 25сm. Издържа до 15кг.",
            Brand = "Wolfram"},
        new Product { ProductName = "Graphiteleader Argento ux 21gargus", Price = 370.00, Type = "Spinning_rod", ProductCount = 332,
            Image = "https://promixfishing.com/wp-content/uploads/2023/02/1-36-300x300.jpg",
            Description = "Фокусирана върху чувствителността при работа. Моделът Argento UX е изключително приятен за използване, чувствителен и с достатъчно голяма сила за да се справи при борба с хищника.",
            Brand = "Graphiteleader"},
        new Product { ProductName = "Shimano stella 10 000sw bpg", Price = 1900.00, Type = "Front_advance", ProductCount = 498,
            Image = "https://m.media-amazon.com/images/I/71AExAK1gRL._AC_SX679_.jpg",
            Description = "Това, което отличава новата Stella SW от останалите е абсолютната мощ. Най-новите и иновативни технологии, които се използват за нейната разработка, издигат модела до съвсем различно ниво за риболовците. Убийственият и същевременно изключително елегантен изглед е съчетан с ненадминато качество на изпълнението.",
            Brand = "Shimano"},
        new Product { ProductName = "Line system super cast pe x8", Price = 80.00, Type = "Braided_line", ProductCount = 363,
            Image = "https://hook.bg/image/cache/catalog/stoka/Linesystem/Eging%20Super%20Cast%20X8%20150m/20210115_160530-1000x1000.jpg",
            Description = "Характеризира се с много плътна оплетка и уникална здравина. В резултат на това влакното е с идеално кръгло сечение, изключително гладко и гарантира перфектен кастинг на големи дистанции(150m). Може да се използва пълноценно за различни типове риболов, включително сладководен и морски спининг. Великолепната сензитивност осигурява пълна представа за движението на примамката, както и за всяко кълване.",
            Brand = "Aoriika"},
        new Product { ProductName = "Shimano sonora sw match", Price = 95.00, Type = "Carp_rod", ProductCount = 414,
            Image = "https://www.tradeinn.com/f/13740/137402719/shimano-fishing-sonora-sw-match-rod.jpg",
            Description = "Гамата Sonora SW Match е нова гама, специално проектирана за риболов на плувка както в солена, така и в сладка вода. Бланкатa има хубава прогресивна извивка и осигурява красива битка с риба. Идеална въдица за риболов на видове като кефал и ципура, чернокоп, както и на сладководните мирни риби - червеноперки, каракуди, платика, шаран и други.",
            Brand = "Shimano"},
        new Product { ProductName = "Shimano sahara 4000 fi", Price = 190.00, Type = "Front_advance", ProductCount = 332,
            Image = "https://cdncloudcart.com/14294/products/images/86/makara-sahara-4000-fi-image_5e95a486713b0_800x800.jpeg?1586865377",
            Description = "Изработена от XT-7 композитен материал – изключително здрав и същевременно лек материал. Sahara 4000 притежава невероятнен max drag - цели 11 кг!  Изящният дизайн и елегантната визия грабват от пръв поглед. Те се допълват по впечатляващ начин от златистата шпула от студенокован алуминий.  Макарата съчетава по един прекрасен начин X-Ship и Hagane предавка в олекотения G-Free корпус. Именно благодарение на X-Ship се постига плавният и мек ход на макарата.",
            Brand = "Shimano"},
        new Product { ProductName = "Trabucco t-force xps match ", Price = 12.00, Type = "Monofilament_line", ProductCount = 429,
            Image = "https://cdncloudcart.com/14178/products/images/42/trabucco-t-force-xps-match-sinking-150m-monofilno-vlakno-62a76edad7c0c_800x800.png?1655144172",
            Description = "T-FORCE XPS MATCH SINKING е бързо потъващо влакно специализирано за мач и фидер риболов. Притежава покритие, осигуряващо висока абразивоустойчивост и тотална липса на памет. Влакното е с отлични показатели за мекота, здравина и износоустойчивост.",
            Brand = "Trabucco"},
        new Product { ProductName = "Ваглер exner carbonfram evolution match", Price = 19.00, Type = "Monofilament_line", ProductCount = 340,
            Image = "https://best-fishing.bg/wp-content/uploads/2019/07/%D0%92%D0%B0%D0%B3%D0%BB%D0%B5%D1%80-Exner-Carbofram-Evolution-Match-80920-2.jpg",
            Description = "Прецизен ваглер, с много голяма чувствителност, за мачов риболов от Exner. Супер качествена изработка от страхотната комбинация на балса, карбон и волфрамово утежнение. Тялото е балсово, а антената карбонова.  Окомплектован с 1брой тънка карбонова антена.",
            Brand = "Exner"},
        new Product { ProductName = "Drennan carbon match", Price = 5.00, Type = "Monofilament_line", ProductCount = 486,
            Image = "https://www.mftackle.com/image/cache/catalog/Drennan/HSCMTM014-500x500.jpg",
            Description = "Уникалният дизайн на серията и характерната форма е представена с по тънка версия на тялото.  Специално създадена за риболов на плувка с щека, мач или директен телескоп.  В зависимост от големината може да я товарите с 1-2-3 червея, по-големите номера с торен червей.  Куките Drennan Carbon Match се предлагат по 10 броя в опаковка с различна големина.",
            Brand = "Drennan"},
    };
